  ...
  return (
    <div className="p-5 w-full h-screen md:px-20 pt-1 md:py-5 overflow-auto 2xl:w-[95%] 2xl:m-auto">
      ...
      <div className="card-container xl:w-[80%] xl:m-auto">
        <div className="cards grid gap-y-5 gap-x-4 grid-cols-2 md:grid-cols-3 md:gap-y-7 md:gap-x-8 list-none text-center mt-5 text-amber-800 font-medium  xl:grid-cols-4 xl:gap-x-20 xl:gap-y-20">
          <div className="card-1 border border-red-600 p-4 md:p-5 rounded-md shadow-lg flex flex-col gap-3 justify-center items-center text-xs md:transition md:duration-500 md:hover:scale-110 ">
